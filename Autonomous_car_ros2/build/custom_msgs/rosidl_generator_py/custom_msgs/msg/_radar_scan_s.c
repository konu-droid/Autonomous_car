...
bool custom_msgs__msg__radar_scan__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "custom_msgs.msg._radar_scan.RadarScan",
        full_classname_dest, 37) == 0);
  }
  custom_msgs__msg__RadarScan * ros_message = _ros_message;
  {  // header
...
PyObject * custom_msgs__msg__radar_scan__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_msgs.msg._radar_scan");
