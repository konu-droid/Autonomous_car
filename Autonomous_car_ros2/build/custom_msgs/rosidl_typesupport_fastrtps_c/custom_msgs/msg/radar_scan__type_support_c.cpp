...
#include "custom_msgs/msg/radar_scan__rosidl_typesupport_fastrtps_c.h"
...
using _RadarScan__ros_msg_type = custom_msgs__msg__RadarScan;
...
size_t get_serialized_size_custom_msgs__msg__RadarScan(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RadarScan__ros_msg_type * ros_message = static_cast<const _RadarScan__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _RadarScan__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_msgs__msg__RadarScan(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_msgs
size_t max_serialized_size_custom_msgs__msg__RadarScan(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_custom_msgs__msg__RadarScan(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_msgs, msg, RadarScan)() {
