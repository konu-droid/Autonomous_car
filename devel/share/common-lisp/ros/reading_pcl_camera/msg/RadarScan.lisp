...
(cl:in-package reading_pcl_camera-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <RadarScan>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RadarScan)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name reading_pcl_camera-msg:<RadarScan> is deprecated: use reading_pcl_camera-msg:RadarScan instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <RadarScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader reading_pcl_camera-msg:header-val is deprecated.  Use reading_pcl_camera-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'point_id-val :lambda-list '(m))
(cl:defmethod point_id-val ((m <RadarScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader reading_pcl_camera-msg:point_id-val is deprecated.  Use reading_pcl_camera-msg:point_id instead.")
  (point_id m))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <RadarScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader reading_pcl_camera-msg:x-val is deprecated.  Use reading_pcl_camera-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <RadarScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader reading_pcl_camera-msg:y-val is deprecated.  Use reading_pcl_camera-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <RadarScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader reading_pcl_camera-msg:z-val is deprecated.  Use reading_pcl_camera-msg:z instead.")
  (z m))

(cl:ensure-generic-function 'range-val :lambda-list '(m))
(cl:defmethod range-val ((m <RadarScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader reading_pcl_camera-msg:range-val is deprecated.  Use reading_pcl_camera-msg:range instead.")
  (range m))

(cl:ensure-generic-function 'velocity-val :lambda-list '(m))
(cl:defmethod velocity-val ((m <RadarScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader reading_pcl_camera-msg:velocity-val is deprecated.  Use reading_pcl_camera-msg:velocity instead.")
  (velocity m))

(cl:ensure-generic-function 'doppler_bin-val :lambda-list '(m))
(cl:defmethod doppler_bin-val ((m <RadarScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader reading_pcl_camera-msg:doppler_bin-val is deprecated.  Use reading_pcl_camera-msg:doppler_bin instead.")
  (doppler_bin m))

(cl:ensure-generic-function 'bearing-val :lambda-list '(m))
(cl:defmethod bearing-val ((m <RadarScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader reading_pcl_camera-msg:bearing-val is deprecated.  Use reading_pcl_camera-msg:bearing instead.")
  (bearing m))

(cl:ensure-generic-function 'intensity-val :lambda-list '(m))
(cl:defmethod intensity-val ((m <RadarScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader reading_pcl_camera-msg:intensity-val is deprecated.  Use reading_pcl_camera-msg:intensity instead.")
  (intensity m))
